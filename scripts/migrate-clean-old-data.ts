...
async function cleanOldTasks() {
  ...
  try {
    ...
    console.log(`[MIGRATION] Found ${oldTasksSnap.size} old tasks in flat collection`);
    ...
    console.log(`[MIGRATION] Found ${oldColumnsSnap.size} old columns in flat collection`);
