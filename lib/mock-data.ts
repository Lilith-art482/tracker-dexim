...
export const mockNotes: Note[] = [
  {
    ...
    blocks: [
      { id: "b1", type: "heading1", content: "План развития продукта" },
      {
        id: "b2",
        type: "paragraph",
        content: "Основные направления на Q3-Q4 2026",
      },
      ...
      { id: "b5", type: "bulletList", content: "Интеграция с календарями" },
      {
        id: "b6",
        type: "todo",
        content: "AI-ассистент для анализа трат",
        checked: true,
      },
      { id: "b7", type: "todo", content: "Тёмная тема", checked: false },
      {
        id: "b8",
        type: "quote",
        content: "Главное — не скорость, а направление",
      },
    ],
  ...
  },
  {
    ...
    blocks: [
      ...
      { id: "b13", type: "numberedList", content: "Подготовить демо" },
      {
        id: "b14",
        type: "code",
        content: "const team = { members: 5, velocity: 30 };",
      },
    ],
