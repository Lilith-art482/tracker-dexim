    ...
    content: (
      <>
        <p className="text-muted-foreground leading-relaxed text-center mb-6">
          In Motion — единое пространство для планировщика, финансов, привычек,
          спорта, питания и заметок. Всё под рукой.
        </p>
        ...
        <div className="grid grid-cols-2 gap-3">
          {[
            ...
            { icon: Apple, label: "Питание", desc: "Калории, меню, вес" },
            {
              icon: StickyNote,
              label: "Заметки",
            ...
            <div
              key={item.label}
              className="flex items-center gap-3 rounded-xl border border-border/30 bg-muted/20 p-3 hover:bg-muted/30 transition-colors"
            >
      ...
      <div className="relative w-full max-w-lg animate-in fade-in zoom-in-95 duration-300">
        <div
          className={cn(
            ...
            "dark:bg-[#16191F]/90 dark:border dark:border-primary/30",
        ...
        >
          ...
          <div
            className={cn(
              "border-t px-6 py-4",
              "dark:border-[#4E6E62]/20 dark:bg-[#1e2128]/40",
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-1.5">
                {STEPS.map((_, i) => (
                  <div
                    key={i}
                    className={`h-1.5 rounded-full transition-all duration-300 ${i === step ? "w-6 bg-primary" : i < step ? "w-1.5 bg-primary/40" : "w-1.5 bg-primary/15"}`}
                  />
                ))}
              </div>
          ...
          <div
            className={cn(
              ...
              "dark:border-[#4E6E62]/15 dark:bg-[#16191F]/50",
