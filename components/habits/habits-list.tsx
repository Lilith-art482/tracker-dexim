          ...
          {STATUS_OPTIONS.map((opt) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-sm font-medium whitespace-nowrap transition-colors shrink-0 ${
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-muted-foreground">
                        ...
                        {habit.complexity && ` · ${COMPLEXITY_LABELS[habit.complexity]}`}
